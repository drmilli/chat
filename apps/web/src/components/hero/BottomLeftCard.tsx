...
/** Live room count, in the spec's stat-card slot. */
export function BottomLeftCard({ rooms }: { rooms: number | null }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)]">Browse rooms</span>
      </motion.button>
    </motion.div>
  );
}
